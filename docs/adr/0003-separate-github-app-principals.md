...
The [Guard registration worksheet](../guard-app-registration.md) provides the proposed permissions and a prefilled GitHub form for a new App. Its installation availability supports both personal and organization customers while release access remains gated independently.
