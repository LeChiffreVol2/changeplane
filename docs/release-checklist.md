...
- [ ] On Vercel Hobby, keep the GitHub App private and verify the root offers a fictional workspace plus owner sign-in while `/api/github?action=login` rejects new installations without redirecting to GitHub.
