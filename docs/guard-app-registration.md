...
**Current status:** The [controlled release observation](current-release.md) supersedes the staging status below. Production uses the separate Guard principal. The original organization canary and its two App installations were removed after a failed same-SHA drill; the replacement Guard installation and requalification remain pending. Credentials were not replaced or read back.
