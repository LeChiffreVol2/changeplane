...
The protected Production source is `42de0baf45474582c9e0e1e61bc53ff1221fb8f1`, managed v14. The [current release observation](current-release.md) separates completed deployment and initial organization-canary evidence from the same-SHA hotfix still awaiting live qualification. Neither local tests nor a reviewed source change establish customer readiness.
